...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202211131217-git
# @@Author           :  Jason Hempstead
# @@Contact          :  jason@casjaysdev.com
# @@License          :  LICENSE.md
# @@ReadME           :  entrypoint.sh --help
# @@Copyright        :  Copyright: (c) 2022 Jason Hempstead, Casjays Developments
# @@Created          :  Sunday, Nov 13, 2022 12:17 EST
# @@File             :  entrypoint.sh
# @@Description      :  entrypoint point for link-warden
...
__heath_check() {
  ...
  start-link-warden.sh healthcheck || status=$((status + 1))
...
HOSTNAME="${HOSTNAME:-casjaysdev-link-warden}"
